...
@section('title', 'Recommended Literary And Arts books')
@section ('content')
  ...
  <a class="navbar-brand"
    ...
    <div class="row">
        <div class="col-lg text-center mb-5"
             ...
             <h2>Recommended Literature and Arts Book's</h2>
        </div>
    </div>
    <div class="mt-4 row card card-articles add-whitespace">
        <div class="col-lg-12 mt-2 container add-whitespace">
            <div class="container">
                ...
                @if(isset($literatureAndArtsArticles))
                    @foreach($literatureAndArtsArticles as $article)
                    <div class="row text-center mt-5">
                        <div class="col-lg-6 col-sm-12">
                            <h3 id="title">
                                <a href="/literature-and-arts/{{ $article->id ?? '' }}">
                                    {{ $article->title ?? ''}}
                                </a>
                            </h3>
