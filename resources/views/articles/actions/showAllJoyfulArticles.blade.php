  ...
  <a class="navbar-brand"
    ...
    <div class="row">
        <div class="col-lg text-center mb-5"
            ...
            <h2>The Latest Articles From Being JOYFUL</h2>
        </div>
    </div>
    <div class="mt-4 row card card-articles add-whitespace">
        <div class="col-lg-12 mt-2 container add-whitespace">
            <div class="container">
                ...
                @if(!$joyfulArticles->isEmpty())
                    @foreach($joyfulArticles as $joyful)
                    <div class="row text-center mt-5">
                        <div class="col-lg-6 col-sm-12">
                            <h3 id="title">
                                <a href="/joyfulArticle/{{ $joyful->id ?? '' }}">
                                    {{ $joyful->title }}
                                </a>
                            </h3>
                        ...
                        <div class="col-lg-6 col-sm-12 mb-3">
                            <a href="/joyfulArticle/{{ $joyful->id ?? '' }}">
                              <img src="{{ $joyful->image_name }}"  alt="main-article-image" height="95%;" width="85%;">
                             </a>
                        </div>
                    </div>
