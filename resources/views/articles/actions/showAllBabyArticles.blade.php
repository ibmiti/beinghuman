...
<nav class="navbar sticky-top navbar-light container container-fluid" style="background-color:white;">
    <a class="navbar-brand" style="font-family: 'Anton'; font-size: 32px;" href="/">BeingHMN
    </a>
</nav>
...
<div class="row">
    <div class="col-lg text-center mb-5" style="padding-bottom: 40px;">
        <h2>The Latest Articles From Being Baby</h2>
    </div>
</div>
<div class="mt-4 row card card-articles add-whitespace">
    <div class="col-lg-12 mt-2 container add-whitespace">
        <div class="container">
            ...
            @foreach($babyArticles as $baby)
            <div class="row text-center mt-5">
                <div class="col-lg-6 col-sm-12">
                    <h3 id="title">
                        <a href="/babyArticle/{{ $baby->id ?? '' }}">
                            {{ $baby->title ?? ''}}
                        </a>
                    </h3>
