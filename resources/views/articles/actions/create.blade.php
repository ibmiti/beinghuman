...
<div class="container container-fluid text-center mt-5" id="firstDiv">
    <div class="container container-fluid mt-5">
        ...
        <div id="thirdDiv">
            ...
            <p class="mb-3 p-3 text-muted">BUILD A NEW ARTICLE OR EDIT AN EXISTING ARTICLE.</p>
        </div>
        <div id="fourthDiv" class="m-2">
            <h2 class="text-muted mt-5 mb-5" id="welcome">WELCOME {{ strtoupper(Auth::user()->name) }}</h2>
        </div>
    </div>
</div>
    ...
    <div class="row mt-3">
        <div class="col-12 text-center">
            ...
            <button type="button"
                ...
                <a href="{{ url('articles/edit/index') }}">
                    Edit Article
                </a>
            </button>
...
<!-- TURN THESE INTO SMALL BUTTONS, WHEN CLICKED, IT ADDS THE TEXT TO THE FIELD -->
                <small id="typeHelp" class="form-text text-muted">
                    ex : Babies, Health, Joyful, Human, Fiction, Non-Fiction, Literature-And-Arts, Stem, Children-Books
                </small>
            </div>
            <div class="form-group">
...
<!-- TURN THESE INTO SMALL BUTTONS, WHEN CLICKED, IT ADDS THE TEXT TO THE FIELD -->
                ...
                ex : Wellness, Development, Reviews, Howtos, Activities, Other
                </small>
                <input type="text"
                        name="subtype"
                        class="form-control form-control-lg"
