...
<nav class="navbar sticky-top navbar-light container container-fluid" style="background-color:white;">
  <a class="navbar-brand"
    ...
    <div class="row">
        <h1 class="col-lg text-center mt-5">Health Articles</h1>
    </div>
    ...
    <div class="row">
        ...
        >
            <h2>The Latest Articles From Being Healthy</h2>
        </div>
    </div>
        ...
        <div class="col-lg-12 mt-2 container add-whitespace">
            <div class="container">
              <div class="row text-center">
               ...
               @if($healthArticles)
                    @foreach($healthArticles as $health)
                     <div class="row text-center mt-5">
                         <div class="col-lg-6 col-sm-12">
                             <h3 id="title">
                                 <a href="/healthArticle/{{ $health->id ?? '' }}">
                                     {{ $health->title ?? ''}}
                                 </a>
                             </h3>
                         ...
                         <div class="col-lg-6 col-sm-12 mb-3">
                            <a href="/healthArticle/{{ $health->id ?? '' }}">
                                 <img src="{{ $health->image_name }}" alt="main-article-image" height="95%;" width="85%;">
                            </a>
                    </div>
                </div>
